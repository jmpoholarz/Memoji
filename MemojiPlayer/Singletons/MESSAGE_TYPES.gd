...
emojiArray				- An array of [xCoord, yCoord, emojiId] representing user emoji placements
...
isPlayer				- True when a given player is not a member of the audience but will answers prompts
