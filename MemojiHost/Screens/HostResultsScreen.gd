...
onready var leftDisplayBox = $MarginContainer/Rows/AnswerBoxes/VBoxContainer/EmojiCanvas
onready var rightDisplayBox = $MarginContainer/Rows/AnswerBoxes/VBoxContainer2/EmojiCanvas
